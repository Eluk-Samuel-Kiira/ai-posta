<?php
// database/migrations/2024_01_01_000009_create_jobs_table.php
...
return new class extends Migration
{
    public function up()
    {
        Schema::create('jobs', function (Blueprint $table) {
            ...
            $table->foreignId('occupational_category_id')->constrained()->onDelete('cascade');
            ...
            $table->decimal('content_quality_score', 5, 2)->default(0);
            ...
            $table->index(['location_id', 'is_active', 'seo_score']);
            ...
            $table->index(['location_id', 'job_category_id', 'seo_score']);
        });
    }
